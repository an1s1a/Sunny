...
import anisia.sunny.MainActivity;
import anisia.sunny.R;
import anisia.sunny.Utility;
import anisia.sunny.data.WeatherContract;

/**
 * Created by Utente on 19/04/2016.
 */
public class SunnySyncAdapter extends AbstractThreadedSyncAdapter {
    public final String LOG_TAG = SunnySyncAdapter.class.getSimpleName();
            ...
            if(hasMessageCode){
                ...
                switch (messageCode) {
                    ...
                    case HttpURLConnection.HTTP_NOT_FOUND:
                        ...
                        return;
                    default: setLocationStatus(getContext(), LOCATION_STATUS_SERVER_DOWN);
                        return;
                }
            }
    ...
    private static void onAccountCreated(Account newAccount, Context context) {
         ...
         */
        SunnySyncAdapter.configurePeriodicSync(context, SYNC_INTERVAL, SYNC_FLEXTIME);
        ...
        if(displayNotification) {
            ...
            if(System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS){
                ...
                if(cursor.moveToFirst()){
                    ...
                    double max = cursor.getInt(INDEX_MAX_TEMP);
                    double min = cursor.getInt(INDEX_MIN_TEMP);
                    String desc = cursor.getString(INDEX_SHORT_DESC);

                    String title = context.getString(R.string.app_name);

                    String pref_icon = Utility.getPreferredIconPack(context);
                    int iconId = Utility.getResourceForWeatherCondition(weatherId);
                    Resources resources = context.getResources();
                    String artIconUrl = Utility.getUrlForWeatherCondition(context, weatherId);
                    ...
                    if(!pref_icon.equalsIgnoreCase(context.getString(R.string.app_name))){
                        ...
                        try{
                            ...
                            Log.e(LOG_TAG, "Error retrieving large icon from " + artIconUrl, e);
