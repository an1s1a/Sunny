    ...
    private String[] getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                mContext.getContentResolver().bulkInsert(WeatherContract.WeatherEntry.CONTENT_URI, arrayValues);
            }

            // Sort order:  Ascending, by date.
            String sortOrder = WeatherContract.WeatherEntry.COLUMN_DATE + " ASC";
            Uri weatherForLocationUri = WeatherContract.WeatherEntry.builWeatherLocationWithStartDate(
